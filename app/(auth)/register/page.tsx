...
const SignupSchema = Yup.object().shape({
    ...
    DOB: Yup.date()
        ...
        .test("age", "You must be at least 10 years old", (value) => {
            ...
            const isOldEnough = age > 10 || (age === 10 && today >= new Date(value.getFullYear() + 10, value.getMonth(), value.getDate()));
            return isOldEnough;
        }),
    role: Yup.string(),
});
                ...
                {({ errors, touched, values, handleChange, setFieldValue, handleBlur }) => (
                    <Form>
                            ...
                            <DatePicker
                                ...
                                slotProps={{
                                    textField: {
                                        ...
                                        helperText: touched.DOB && errors.DOB ? String(errors.DOB) : undefined,
                                    },
                                }}
                            />
                        </Box>
                        ...
                        <Box className="mt-5 w-full">
                            ...
                            <Button className="mt-3" variant="outlined" fullWidth onClick={() => router.push("/login")}>
                                Log in
                            </Button>
                        </Box>
                    </Form>
